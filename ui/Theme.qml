...
// Winkel reads the Omarchy theme the same way Flea does: colors.toml and
...
Singleton {
    ...
    readonly property QtObject font: QtObject {
        property string family: Quickshell.env("WINKEL_FONT") || "JetBrainsMono Nerd Font"
    ...
    // compositor's rounding is not a value Winkel could disagree with twice.
    Process {
        id: roundingQuery
        running: true
